...
const jsonencode = jsondata => encodeURIComponent(encode(encodeURIComponent(JSON.stringify(jsondata))));
const jsondecode = jsonstr => JSON.parse(decodeURIComponent(decode(decodeURIComponent(jsonstr))));
